<?php
add_action('admin_menu', 'amr_contact_us_add_fields');

/**
 * Add more fields to post type 'movie'
 */
function amr_contact_us_add_fields() {
	
	// Add Name field
    add_meta_box('contact_us_name', __('Name'), 'amr_contact_us_name_show', 
    	'contact_us', 'normal', 'high');

	// Add Email field
    add_meta_box('contact_us_email', __('Email'), 'amr_contact_us_email_show', 
    	'contact_us', 'normal', 'high');

	// Add Message field
    add_meta_box('contact_us_message', __('Message'), 'amr_contact_us_message_show', 
    	'contact_us', 'normal', 'high');	
 ...
 * Show name textbox
 */
function amr_contact_us_name_show() {
    global $post;
 ...
 * Show email textbox
 */
function amr_contact_us_email_show() {
    global $post;
 ...
 */
function amr_contact_us_message_show() {
    global $post;
...
add_action('save_post', 'amr_save_contact_us_advbox');

// Save data from meta box
function amr_save_contact_us_advbox($post_id) {
